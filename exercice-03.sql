...
SELECT *
FROM student
WHERE email LIKE '%.fr' OR create_date <= '2021-01-10'
...
SELECT *
FROM student
WHERE email LIKE '%.fr' AND create_date <= '2021-01-10'
...
SELECT *
FROM student
WHERE create_date > '2021-01-1' AND create_date <= '2021-01-10'
...
SELECT *
FROM project
WHERE description NOT LIKE '%Dolores%' OR create_date <= '2021-07-01'
...
SELECT *
FROM project
WHERE description NOT LIKE '%Dolores%' AND create_date <= '2021-07-01'
...
SELECT *
FROM project
WHERE create_date >= '2021-01-1' AND create_date <= '2021-07-01'
